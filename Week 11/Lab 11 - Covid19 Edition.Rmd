...
## Create a second dataframe called MaxCountyCases.
...
## number of cases. Call this column MaxCases.
##
## Pro Tip: You are going to need to use the assignment operator (<-)
## to complete this task. This will let you create a new dataframe.
## 
...
## counties which have had 1000 or more cases. We will use
...
CountyMapData <- 
    CountyData %>%
    inner_join(MaxDate, by = c("fips","week_of"="MaxDate")) %>%
